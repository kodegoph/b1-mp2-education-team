                ...
                <div className="contacts__header p-6 border border-l-0 border-t-0 border-b-0 border-c_light">
                  <div className="contacts__header__inbox flex justify-between items-center mb-3">
                    <div className="flex items-center">
                      ...
                      <p className="notif-inbox btn bg-tag rad rad-circle md:hidden text-secondary pe-2 ps-2 mb-0 me-1 pt-0 pb-0 border-0 text-nowrap">
                        4
                      </p>
                      <p className="btn bg-tag rad rad-12 hidden md:inline text-secondary pt-1 pe-2 pb-1 ps-2 mb-0 text-nowrap">
                        4 New
                      </p>
                    </div>
                  ...
                  <div className="contacts__header__options btn-group flex flex-wrap justify-content-center bg-c-light rounded-3 p-2">
                    <div className="col-lg-6">
                      ...
                      />
                      <label
                        className="btn btn-outline-c-white border-0 fw-bold w-full"
                        for="rdbOpen"
                      >
                        Open
                      </label>
