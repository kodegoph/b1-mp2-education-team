...
import Dropdown from "./../dropdown/DropdownOrg";
import DropdownR from "./../dropdown/DropdownUser";
        ...
        <div className="container-fluid header-container p-4">
          <div className="flex items-center">
            <div>
              <div className="flex items-center">
                <div
                  id="header__avatar__image"
                  className="header__avatar__image mr-4"
                ...
                <div className="hidden md:flex flex-col justify-center mr-2">
                  ...
                  <p className="m-0 text-base text-black text-c_gray">
                    team@dimo.com
                  </p>
                </div>
            ...
            <div className="hidden xl:block ml-10">
              <div>
                ...
                <p className="m-0 text-base text-black text-c_gray whitespace-nowrap ">
